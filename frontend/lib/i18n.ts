...
const resources = {
  ...
  en: {
    translation: {
      ...
      contactPage: {
        ...
        faq2A:
          "Our hourly rates vary by time and day. Contact us for current pricing or visit during our opening hours.",
  ...
  de: {
    translation: {
      ...
      footer: {
        tagline:
          "Dein Billardclub und Bar. Die perfekte Kombination aus Sport und Unterhaltung.",
        contact: "Kontakt",
      ...
      home: {
        ...
        features: {
          ...
          friendlyCommunityText:
            "Eine einladende Community für alle – vom Anfänger bis zum Profi.",
