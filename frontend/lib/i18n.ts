    ...
    translation: {
      ...
      dashboard: {
        ...
        dialogs: {
          ...
          importDescription: "Carica un file Excel (.xlsx) con colonne: firstName, lastName, email. I membri esistenti verranno aggiornati.",
          ...
          importUpdated: "Aggiornati {{count}} membri esistenti",
        ...
        toasts: {
          ...
          importCompleteDesc: "Creati {{created}} nuovi membri, aggiornati {{updated}} esistenti.",
        },
        importSteps: {
          parsing: "Lettura del file Excel",
          checking: "Verifica utenti esistenti",
          creating: "Creazione nuovi membri",
          updating: "Aggiornamento membri esistenti",
        },
        realtime: {
    ...
    translation: {
      ...
      dashboard: {
        ...
        dialogs: {
          ...
          importDescription: "Upload an Excel file (.xlsx) with columns: firstName, lastName, email. Existing members will be updated.",
          ...
          importUpdated: "Updated {{count}} existing members",
        ...
        toasts: {
          ...
          importCompleteDesc: "Created {{created}} new members, updated {{updated}} existing.",
        },
        importSteps: {
          parsing: "Parsing Excel file",
          checking: "Checking existing users",
          creating: "Creating new members",
          updating: "Updating existing members",
        },
        realtime: {
    ...
    translation: {
      ...
      dashboard: {
        ...
        dialogs: {
          ...
          importDescription: "Excel-Datei (.xlsx) mit Spalten: firstName, lastName, email hochladen. Bestehende Mitglieder werden aktualisiert.",
          ...
          importUpdated: "{{count}} bestehende Mitglieder aktualisiert",
        ...
        toasts: {
          ...
          importCompleteDesc: "{{created}} neue Mitglieder erstellt, {{updated}} bestehende aktualisiert.",
        },
        importSteps: {
          parsing: "Excel-Datei wird gelesen",
          checking: "Bestehende Benutzer werden geprüft",
          creating: "Neue Mitglieder werden erstellt",
          updating: "Bestehende Mitglieder werden aktualisiert",
        },
        realtime: {
