    ...
    translation: {
      ...
      dashboard: {
        ...
        dialogs: {
          ...
          importStepUpload: "1. Carica",
          importStepReview: "2. Revisione",
          importStepCreate: "3. Crea",
          importSelectFile: "Seleziona un file CSV",
          importChooseFile: "Scegli file",
          importNoFile: "Nessun file selezionato",
          importFileSelectedLabel: "File selezionato:",
          importFileSelected: "File selezionato: {{name}} ({{size}})",
          importSplitHint: "I file grandi vengono suddivisi in batch più piccoli per evitare i limiti di AWS Lambda.",
          importFileSummary: "Righe: {{rows}} • Idonei: {{eligible}}",
          ...
          importPreviewRowCount: "Righe in anteprima: {{count}}",
          importShowPreview: "Mostra righe",
          importHidePreview: "Nascondi righe",
          importPreviewHidden: "Anteprima nascosta per velocizzare l'importazione. Puoi mostrarla se serve.",
          ...
          importPreviewProgress: "Verifica email esistenti: {{current}} / {{total}}",
          importImportProgress: "Creazione membri: {{current}} / {{total}}",
          importParsing: "Lettura del file...",
    ...
    translation: {
      ...
      dashboard: {
        ...
        dialogs: {
          ...
          importStepUpload: "1. Upload",
          importStepReview: "2. Review",
          importStepCreate: "3. Create",
          importSelectFile: "Select a CSV file",
          importChooseFile: "Choose file",
          importNoFile: "No file selected",
          importFileSelectedLabel: "Selected file:",
          importFileSelected: "Selected file: {{name}} ({{size}})",
          importSplitHint: "Large files are split into smaller batches to avoid AWS Lambda limits.",
          importFileSummary: "Rows: {{rows}} • Eligible: {{eligible}}",
          ...
          importPreviewRowCount: "Preview rows: {{count}}",
          importShowPreview: "Show rows",
          importHidePreview: "Hide rows",
          importPreviewHidden: "Preview hidden to speed up the import. You can show it if needed.",
          importNoPreview: "No new members found in this file.",
          importPreviewCta: "Preview",
          importPreviewing: "Generating preview...",
          importPreviewProgress: "Checking existing emails: {{current}} / {{total}}",
          importImportProgress: "Creating members: {{current}} / {{total}}",
    ...
    translation: {
      ...
      dashboard: {
        ...
        dialogs: {
          ...
          importStepUpload: "1. Hochladen",
          importStepReview: "2. Prüfen",
          importStepCreate: "3. Erstellen",
          importSelectFile: "CSV-Datei auswählen",
          importChooseFile: "Datei auswählen",
          importNoFile: "Keine Datei ausgewählt",
          importFileSelectedLabel: "Ausgewählte Datei:",
          importFileSelected: "Ausgewählte Datei: {{name}} ({{size}})",
          importSplitHint: "Große Dateien werden in kleinere Batches aufgeteilt, um AWS-Lambda-Limits zu vermeiden.",
          importFileSummary: "Zeilen: {{rows}} • Geeignet: {{eligible}}",
          ...
          importPreviewRowCount: "Vorschauzeilen: {{count}}",
          importShowPreview: "Zeilen anzeigen",
          importHidePreview: "Zeilen ausblenden",
          importPreviewHidden: "Vorschau verborgen, um den Import zu beschleunigen. Bei Bedarf anzeigen.",
          ...
          importPreviewProgress: "Vorhandene E-Mails werden geprüft: {{current}} / {{total}}",
          importImportProgress: "Mitglieder werden erstellt: {{current}} / {{total}}",
